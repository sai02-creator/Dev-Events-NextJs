 ...
 * - Generates URL-friendly slug from title only when title is modified
...
// Export Event model, reusing existing model in development to prevent OverwriteModelError
